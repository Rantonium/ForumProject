<article class="p-5 bg-white shadow">
    ...
    <div class="grid grid-cols-8 gap-3 relative">
        ...
        <div class="col-span-6 space-y-4">
            ...
            <a href="{{ route('threads.show', [$thread->channel->slug(), $thread->slug()]) }}" class="space-y-2">
        ...
        <div class="absolute right-2">
            <div class="flex space-x-2">
                ...
                <a href="{{ route('threads.tags.index', $tag->slug()) }}" class="p-1 text-xs text-white bg-indigo-400 rounded">
                    {{ $tag->name() }}
                </a>
                @endforeach
            </div>
