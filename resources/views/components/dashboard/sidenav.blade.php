<aside class="min-h-screen col-span-1 px-8 bg-white shadow">
    <div class="py-6 space-y-7">
        ...
        <div>
            ...
            <div>
                <x-sidenav.link href="{{ route('admin.channels.index') }}" :active="request()->routeIs('admin.channels.index')">
                    <x-zondicon-view-tile class="w-3 text-green-400" />
                    <span>{{ __('Index') }}</span>
                </x-sidenav.link>
            </div>
            <div>
                <x-sidenav.link href="{{ route('admin.channels.create') }}" :active="request()->routeIs('admin.channels.create')">
