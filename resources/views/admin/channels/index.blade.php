            ...
            <table class="min-w-full">
                ...
                @foreach($channels as $channel)
                    <tr>
                        ...
                        <x-table.data>
                            <div class="text-center"> {{ $channel->created_at->format('d/m/y') }}</div>
                        </x-table.data>
                        <x-table.data>
                            <div class="flex justify-center space-x-4">
                                <a href="{{ route('admin.channels.edit', $channel) }}" class="text-yellow-400">
                                    <x-zondicon-edit-pencil class="w-5 h-5"/>
                                </a>
                                <x-form action="{{ route('admin.channels.delete', $channel) }}" method="DELETE">
